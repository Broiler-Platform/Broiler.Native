...
public static class Direct2DSurfaceApi
{
    ...
    public delegate int CreateSwapChainForCompositionProc(
        IntPtr self,
        IntPtr device,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate int CreateSwapChainForHwndProc(
        IntPtr self,
        IntPtr device,
        IntPtr hwnd,
        ref DxgiNative.DXGI_SWAP_CHAIN_DESC1 desc,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate int ResizeBuffersProc(
        IntPtr self,
        uint bufferCount,
        uint width,
        uint height,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate int CreateBitmapFromDxgiSurfaceProc(
        IntPtr self,
        IntPtr dxgiSurface,
